...
typedef enum
{
  ...
  CUSTOM_STM_LED_C,
  CUSTOM_STM_SWITCH_C,
  CUSTOM_STM_DATA_IN_C,
  CUSTOM_STM_DATA_OUT_C,
  CUSTOM_STM_DATA_OUT_T_C,
...
typedef enum
{
  ...
  /* DATA_IN_Char */
  CUSTOM_STM_DATA_IN_C_READ_EVT,
  CUSTOM_STM_DATA_IN_C_WRITE_NO_RESP_EVT,
  /* DATA_OUT_Char */
  CUSTOM_STM_DATA_OUT_C_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_DATA_OUT_C_NOTIFY_DISABLED_EVT,
  /* DATA_OUT_Time_Char */
  CUSTOM_STM_DATA_OUT_T_C_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_DATA_OUT_T_C_NOTIFY_DISABLED_EVT,
...
extern uint16_t SizeData_In_C;
extern uint16_t SizeData_Out_C;
extern uint16_t SizeData_Out_T_C;
